...
import BusinessLocation from "../../models/admin/businessLocation.js";
import UsCity from "../../models/admin/UsCity.js";

export const getBusinessLocations = async (req, res) => {
  try {
    ...
    const totalRecordsPromise =
      BusinessLocation.estimatedDocumentCount(searchFilter);
    ...
    return helper.error(
      res,
      "Error fetching business locations. Please try again."
    );
  }
};
