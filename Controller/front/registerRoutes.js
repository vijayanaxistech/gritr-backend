  ...
  registerUser: async (req, res) => {
    try {
      ...
      return helper.success(
        res,
        "You’ve successfully registered! Welcome to Gritr!",
        {
          id: newUser._id,
  ...
  checkEmail: async (req, res) => {
    try {
      ...
      if (!user) {
        return helper.error(
          res,
          "No user found with this email. Please use a registered email.",
          {}
        );
      }
      ...
      return helper.success(res, "Verification code sent successfully", {
        email,
      });
    } catch (error) {
